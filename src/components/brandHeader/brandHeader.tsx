    ...
    <div className={styles.brandLogo}>
      <div>
        {supplier ? (
          <>
            <h1
              className={`${shrikhand.className} ${styles.header} ${styles.supplierBrandHeaderH1}`}
            >
              Silly Stuffs
            </h1>
            <div className={`${sintony.className}`} style={{ color: 'white' }}>
              <b>STAFF</b>
            </div>
          </>
        ) : (
      ...
      {supplier ? (
        <SupplierLogoComponent
          className={`mx-auto h-11 w-auto logo ${styles.brandHeaderLogo} ${styles.logo}`}
        />
      ) : (
